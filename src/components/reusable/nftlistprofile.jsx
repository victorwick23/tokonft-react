...
export default function NftListProfile() {
    return (
        ...
        <div className="pt-3">
            <p className="text-prime font-nav tracking-tighter leading-tight text-lg md:text-2xl">UNTITLED</p>
            <div className="flex justify-between items-center pt-1 md:pt-2">
              <p className="text-prime font-nav tracking-tighter leading-tight text-base md:text-xl">0.4 BNB</p>
