        ...
        <div className="pt-14">
            <div className="">
                <p
                    ...
                    Top Artist</p>
                <div
                    className="grid grid-cols-4 gap-x-8 gap-y-10 bg-gradient-to-b from-softDark via-softDark to-dark px-5 py-8 justify-center rounded-full border-2 border-purple z-0">
                    <Link to="/profile">
                    <Topartist />
                    </Link>
                    <Link to="/profile">
